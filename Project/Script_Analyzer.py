...
class ScriptAnalyzer:
    def __init__(self, script_path, recipient_email):
...
if __name__ == "__main__":
    analyzer = ScriptAnalyzer(script_path, recipient_email)  # Use the uploaded file path and recipient email from the form
